...
import it.unimib.worldnews.data.repository.news.NewsRepositoryWithLiveData;
import it.unimib.worldnews.data.repository.user.IUserRepository;
import it.unimib.worldnews.data.repository.user.UserRepository;
import it.unimib.worldnews.data.service.NewsApiService;
import it.unimib.worldnews.data.source.news.BaseFavoriteNewsDataSource;
import it.unimib.worldnews.data.source.news.BaseNewsLocalDataSource;
import it.unimib.worldnews.data.source.news.BaseNewsRemoteDataSource;
import it.unimib.worldnews.data.source.news.FavoriteNewsDataSource;
import it.unimib.worldnews.data.source.news.NewsLocalDataSource;
import it.unimib.worldnews.data.source.news.NewsMockRemoteDataSource;
import it.unimib.worldnews.data.source.news.NewsRemoteDataSource;
...
import it.unimib.worldnews.data.source.user.UserAuthenticationRemoteDataSource;
import it.unimib.worldnews.data.source.user.UserDataRemoteDataSource;
